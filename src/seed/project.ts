...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    description:
      'Social media app to connect with the people close to you and share memories.',
  ...
  },
  {
    ...
    description:
      'Design for a movie review application with different pages. The main foucus is on the design and makeing the UI clearner.',
