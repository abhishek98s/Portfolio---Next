    ...
    <nav className='fixed top-[12px] w-full z-50 '>
      <div className='custom-container'>
        ...
        >
          ...
          {isHome && isMenuOpen && (
            <ul
              className={`${style.nav_links_wrapper} hidden lg:flex nav-links-wrapper list-none`}
            >
          ...
          {isHome && (
            <ul
              className={`${style.nav_links_wrapper_desktop} hidden lg:flex nav-links-wrapper list-none`}
            >
              <li className='w-full lg:w-[100px] h-[60px] lg:h-[40px] rounded-[4px] inline-flex justify-center items-center color-primary-400 text-[16px]'>
          ...
          {isHome && (
            <div
              onClick={toggleMenu}
              className={`${style.menu_wrapper} lg:hidden cursor-pointer flex justify-center items-center max-w-[45px] w-full h-[45px]`}
            >
              <div
                className={`${style.menu_box} ${
                  isMenuOpen ? style.active : ''
                } space-y-[4px] max-w-[36px] w-full h-[18px]`}
              >
