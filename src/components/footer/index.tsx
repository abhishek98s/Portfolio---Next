            ...
            <div className="custom-container">
                <div className="relative z-10 flex flex-col gap-[40px]">
                    <div className="top flex flex-col md:flex-row items-center justify-between">
                        ...
                        <ul className={`flex flex-col md:flex-row nav-links-wrapper list-none`}>
                ...
                <a href="/abhishek-shakya-cv.pdf" download='abhishek-shakya-cv' className='hover:translate-y-[-10px] animate-bounce transition-opacity z-50 shadow-slate-400 md bg-primary-0 w-[60px] rounded-full h-[60px] flex-center border-primary-10 fixed right-[20px] bottom-[20px]'>
                    <Image src={'/download.svg'} alt='download' width={24} height={26} />
                </a>
>>>>>>> ab0e9ba7730cbbacca3e6b393741a72891d46662
            </div>
