    ...
    <>
      <main className={`relative pt-[256px] pb-[56px]`}>
        ...
        <Image
          ...
          height={894}
          loading="eager"
          className="absolute top-0 bottom-0 left-0 right-0 w-full h-full object-cover z-10 object-center"
          alt="pattern"
          decoding="async"
        />
            ...
            <div className="max-w-[587px] w-full">
              <div className="relative">
                ...
                <div className="description color-primary-400 text-[20px] mb-[56px]">
                  ...
                  <div>
                    solve
                    <span className="inline-flex items-center justify-center font-bold mx-[6px] w-fit rounded-[4px] bg-primary-10 color-primary-800 px-[12px] py-[4px]">
